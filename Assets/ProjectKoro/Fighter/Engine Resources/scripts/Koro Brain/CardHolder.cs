...
public class CardHolder : MonoBehaviour
{
    ...
    void Start()
    {
        //KoroData = new DataCard(SpeciesCard);//this fills the Data card variable with a new data card and whatever species card is plugged in
        //MatchConnecter.ConnectToPlayerBrain();//USUALLY CALLED BY KORO PARTY, SET THIS WAY FOR COMBAT TESTING.
    ...
    public void LoadRig(DataCard NewKoroData)//this fills the data card variable with an already made data card
    {
        KoroData = NewKoroData;
    } 
