...
{
    protected KoroCore Core;//passes in script that is on the player
    ...
    public State(KoroCore core, StateMachine stateMachine, string animBoolName)//constructor, all states need these
    {
        this.Core = core;
