...
public class KoroCore : MonoBehaviour//attaches to game object to create states and statemachine
{

    public CardHolder CardHolder { get; private set; }
    public MatchConnecter MatchConnecter { get; private set; }

    public KoroCore BaseCore;//this is filled by itself so individual cores can properly read it, used in attack states
    ...
    public void Die()//called by PlayerDeadState to disable hitboxes and input script
    {
        ...
        //communicate when koro Dies
        MatchConnecter.KoroDead();
