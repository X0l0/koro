...
{
    public KuroCore KuroCore { get; private set; }
    ...
    public void ConnectCore(KuroCore Core)
    {
        KuroCore = Core;
    }
    ...
    {
        KuroCore = null;//part of core testing
    }
    public void Update()
    {
