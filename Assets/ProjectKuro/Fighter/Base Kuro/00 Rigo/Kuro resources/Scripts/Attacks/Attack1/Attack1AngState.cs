...
public class Attack1AngState : AbilityState
{
    public Attack1AngState(RigoCore core, StateMachine stateMachine, string animBoolName) : base(core, stateMachine, animBoolName)
    {
    }
